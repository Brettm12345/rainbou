...
// Hex returns an HTML color without the leading #
func (c *Color) Hex() string {
	return fmt.Sprintf("%02x%02x%02x", c.R, c.G, c.B)
}

// HexBGR returns an HTML color with it components reversed
func (c *Color) HexBGR() string {
	return fmt.Sprintf("%02x%02x%02x", c.B, c.G, c.R)
}

// DHex returns an HTML-like color with its components doubled
func (c *Color) DHex() string {
	return fmt.Sprintf("%02x%02x%02x%02x%02x%02x", c.R, c.R, c.G, c.G, c.B, c.B)
}

// RGB returns an array of color color components
...
// SRGB returns an array of color components where their values are between 0 and 1
